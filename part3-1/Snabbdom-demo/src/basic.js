...
import  {classModule}  from '../node_modules/snabbdom/src/modules/class.ts'
import {propsModule}  from '../node_modules/snabbdom/src/modules/props.ts'
import { styleModule } from '../node_modules/snabbdom/src/modules/style.ts'
import  {eventListenersModule}  from '../node_modules/snabbdom/src/modules/eventlisteners.ts'
...
// ]
var originalData = [
  { rank: 1, name: 'º®±ùÉäÊÖ', age: '1', elmHeight: 0 },
  { rank: 3, name: 'ÉÍ½ðÁÔÈË', age: '2', elmHeight: 0 },
  { rank: 4, name: '°µÒ¹ÁÔÊÖ', age: '4', elmHeight: 0 },
  { rank: 5, name: '½£Ê¥', age: '59', elmHeight: 0 },
 ]
var data = [
  originalData[0],
  originalData[1],
...
function add () {
  ...
  data = [{ rank: nextKey++, name: n.name, age: n.age, elmHeight: 0 }].concat(data)
  render()
  render()
}
  ...
  return h('div', [
    ...
    h('div', [
      ...
      h('span.btn-group', [
        ...
        h('a.btn.title', { class: { active: sortBy === 'name' }, on: { click: [changeSort, 'name'] } }, 'name'),
        h('a.btn.desc', { class: { active: sortBy === 'age' }, on: { click: [changeSort, 'age'] } }, 'age'),
      ]),
    ]),
